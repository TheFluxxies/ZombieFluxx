...
public class MenuView extends Application {
	...
	private class GameMenu extends Parent {
		public GameMenu() throws IOException {
			...
			InputStream rules = Files.newInputStream(Paths.get("res/images/ZombieFluxxRules.back__0.png"));
			Image imgRules = new Image(rules);
			rules.close();

			ImageView imgRulesView = new ImageView(imgRules);
			ScrollPane scrollpane1 = new ScrollPane();
			scrollpane1.setPrefSize(650,600);
			...
			getChildren().addAll(bg,menu0,scrollpane1);
